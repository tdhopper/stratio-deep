...
public class CassandraCellRDDTest extends CassandraRDDTest<Cells> {
    private final Logger logger = Logger.getLogger(CassandraCellRDDTest.class);
    ...
    protected void checkComputedData(Cells[] entities) {
        ...
        for (Cells cells : entities) {
            ...
            if (indexCells.equals(
                    new Cells("cql3_cf", CassandraCell.create("name", "pepito_3", true, false), CassandraCell.create(
                            "gender", "male",
                            true, false), CassandraCell.create("age", -2, false, true), CassandraCell.create("animal",
                            "monkey", false, true)))) {
    ...
    protected DeepJobConfig<Cells> initReadConfig() {
        ...
        DeepJobConfig<Cells> rddConfig = new DeepJobConfig<>(new ExtractorConfig<>(Cells.class));
        ...
        rddConfig.getExtractorConfiguration().setExtractorImplClass(CassandraCellExtractor.class);
        return rddConfig;
    }
