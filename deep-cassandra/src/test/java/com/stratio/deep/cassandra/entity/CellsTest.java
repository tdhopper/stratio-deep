...
public class CellsTest {
    ...
    public void testInstantiation() {
        ...
        Cells keys = new Cells("defaultTable", CassandraCell.create("id1", "", true, false), CassandraCell.create(
                "id2", "", false, true));
    ...
    public void testGetCellByName() {
        Cells values = new Cells("defaultTable", CassandraCell.create("domain_name", "abc.es"), CassandraCell.create(
                "url", ""), CassandraCell.create(
    ...
    public void testSplitCells() {
        ...
        assertNotNull(keys);
        assertTrue(keys.equals(new Cells("defaultTable", CassandraCell.create("id2", "", false, true), CassandraCell
                .create("id1", "", true, false))));

        Cells values = cells.getValueCells();
        assertNotNull(values);
        assertTrue(values.equals(
                new Cells("defaultTable", CassandraCell.create("domain_name", ""), CassandraCell.create(
                        "response_time", ""), CassandraCell.create("url", ""),
                        CassandraCell.create("response_code", ""), CassandraCell.create("download_time", ""))
                ));
    }
