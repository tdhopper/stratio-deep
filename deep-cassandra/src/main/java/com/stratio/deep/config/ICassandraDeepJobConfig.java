...
/**
 * Defines the public methods that each Stratio Deep Cassandra configuration object should
 * implement.
 */
public interface ICassandraDeepJobConfig<T> extends IDeepJobConfig<T> {
   ...
   * propagating the filter we check if an index exists in Cassandra.
   * 
   ...
   * 
   * @return true if this configuratuon object is suitable for writing to cassandra, false
   *         otherwise.
   */
   ...
   * Defaults to FALSE.
   * 
   * @param createTableOnWrite a boolean that tells this configuration obj to create missing tables
   *        on write.
   * @return this configuration object.
   */
