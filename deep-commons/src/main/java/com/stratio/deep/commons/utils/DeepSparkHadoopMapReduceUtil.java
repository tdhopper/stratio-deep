...
public class DeepSparkHadoopMapReduceUtil {
    ...
    public static JobContext newJobContext(Configuration conf, JobID jobId) {
        try {
            ...
            throw new DeepInstantiationException("to use hadoop classes, we need them in the classpath  "
                    + e.getMessage());
        }
    }
    ...
    public static TaskAttemptID newTaskAttemptID(String jtIdentifier, int jobId, boolean isMap, int taskId,
        ...
        try {
            ...
            Constructor constructor = clazz.getDeclaredConstructor(String.class, int.class, boolean.class, int.class,
                    int.class);
