...
/**
 * {@link CqlPagingRecordReader} implementation that returns an 
 * instance of a {@link DeepCqlPagingRecordReader}.
 * 
...
public class DeepCqlPagingInputFormat extends CqlPagingInputFormat {
	 ...
	 */
	@Override
	public RecordReader<Map<String, ByteBuffer>, Map<String, ByteBuffer>> createRecordReader(
