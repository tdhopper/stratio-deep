...
public final class WritingCellToCassandra {
    ...
    public static void doMain(String[] args) {
        ...
        // --- INPUT RDD
        DeepJobConfig<Cells> inputConfig = new DeepJobConfig<>(new ExtractorConfig(Cells.class));
        ...
        // --- OUTPUT RDD
        DeepJobConfig<Cells> outputConfig = new DeepJobConfig<>(new ExtractorConfig(Cells.class));
