...
/**
 * Author: Emmanuelle Raffenne Date..: 14-feb-2014
 */
public final class GroupingByKey {
    ...
    public static void doMain(String[] args) {
        ...
        JavaPairRDD<String, TweetEntity> pairsRDD = rdd.toJavaRDD().mapToPair(
                new PairFunction<TweetEntity, String, TweetEntity>() {
                    @Override
