...
public final class WritingEntityToCassandra {
    ...
    public static void doMain(String[] args) {
        ...
        JavaPairRDD<String, DomainEntity> pairRDD = inputRDD.toJavaRDD().mapToPair(
                new PairFunction<DomainEntity, String,
                DomainEntity>() {
                    @Override
        ...
        // --- OUTPUT RDD
        DeepJobConfig<DomainEntity> outputConfig = new DeepJobConfig<>(new ExtractorConfig(DomainEntity.class));
